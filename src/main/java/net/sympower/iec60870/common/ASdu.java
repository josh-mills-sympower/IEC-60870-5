...
public class ASdu {
    ...
    public static ASdu decode(ExtendedDataInputStream is, IEC60870Settings settings, int aSduLength) throws IOException {
    ...
    public int encode(byte[] buffer, int i, IEC60870Settings settings) {
