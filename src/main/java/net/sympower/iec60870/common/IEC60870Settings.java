...
public class IEC60870Settings {
    ...
    private int linkAddressLength; // IEC-101 link address length (1-2 bytes)

    private int connectionTimeout;
    private int interFrameDelayMs; // Configurable delay between frame transmissions
    ...
    public IEC60870Settings() {
        ...
        this.linkAddressLength = 2; // Default 2 bytes for IEC-101

        this.connectionTimeout = 600_000; // 10 minutes instead of 30 seconds
        this.interFrameDelayMs = 0; // Default no delay, calculated automatically
    }
