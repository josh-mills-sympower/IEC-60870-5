...
import net.sympower.iec60870.iec104.api.Iec104ClientBuilder;
...
public class SampleIEC104Client {
    ...
    private static void printMenu() {
        System.out.println("\nAvailable commands:");
        System.out.println("  i - interrogation");
        System.out.println("  c - clock synchronization");
        System.out.println("  s - single command (select)");
        System.out.println("  e - single command (execute)");
        System.out.println("  p - stop data transfer");
        System.out.println("  t - start data transfer");
    ...
    public static void main(String[] args) throws IOException {
        ...
        Iec104ClientConnection connection = new Iec104ClientBuilder(hostname, port)
            ...
            try {
                switch (input.toLowerCase()) {
                    ...
                    case SINGLE_COMMAND_SELECT:
                        ...
                        connection.singleCommand(commonAddress, CauseOfTransmission.ACTIVATION, 5000,
